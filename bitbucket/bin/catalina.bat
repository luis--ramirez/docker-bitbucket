...
:emptyClasspath
set "CLASSPATH=%CLASSPATH%%CATALINA_HOME%\bin\bitbucket-bootstrap.jar;%CATALINA_HOME%\bin\bootstrap.jar"
...
set MAINCLASS=com.atlassian.stash.internal.catalina.startup.Bootstrap
set ACTION=start
