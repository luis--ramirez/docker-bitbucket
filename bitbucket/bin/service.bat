...
set "CLASSPATH=%CATALINA_HOME%\bin\bitbucket-bootstrap.jar;%CATALINA_HOME%\bin\bootstrap.jar;%CATALINA_BASE%\bin\tomcat-juli.jar;%%BITBUCKET_HOME%%\lib\*"
...
"%EXECUTABLE%" //IS//%SERVICE_NAME% ^
    ...
    --StartClass com.atlassian.stash.internal.catalina.startup.Bootstrap ^
    --StopClass com.atlassian.stash.internal.catalina.startup.Bootstrap ^
    --StartParams start ^
    --StopParams stop ^
    --JvmOptions "-Dcatalina.home=%CATALINA_HOME%;-Dcatalina.base=%CATALINA_BASE%;-Djava.endorsed.dirs=%CATALINA_HOME%\endorsed;-Djava.io.tmpdir=%CATALINA_BASE%\temp;-Dmail.mime.decodeparameters=true;-Dorg.apache.jasper.runtime.BodyContentImpl.LIMIT_BUFFER=true;-Dfile.encoding=UTF-8;-Datlassian.standalone=BITBUCKET;-Djava.library.path='%CATALINA_HOME%\lib\native;%BITBUCKET_HOME%\lib\native';-Dorg.apache.catalina.connector.Response.ENFORCE_ENCODING_IN_GET_WRITER=false;-Djava.util.logging.manager=org.apache.juli.ClassLoaderLogManager;-Djava.util.logging.config.file=%CATALINA_BASE%\conf\logging.properties;" ^
    --JvmMs 512 ^
