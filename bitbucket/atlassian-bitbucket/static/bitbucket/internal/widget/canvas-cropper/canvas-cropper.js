...
define('bitbucket/internal/widget/canvas-cropper', ['jquery', 'bitbucket/internal/util/feature-detect'], function ($, featureDetect) {
    ...
    CanvasCropper.prototype.init = function (width, height, opts) {
        ...
        this.canvas = $('<canvas/>').attr('width', this.width).attr('height', this.height).get(0);
        return this;
    };
