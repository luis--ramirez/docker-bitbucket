...
define('bitbucket/internal/widget/image-explorer', ['aui', 'fd-slider', 'jquery', 'lodash'], function (AJS, fdSlider, $, _) {
    ...
    ImageExplorer.prototype.initScaleSlider = function () {
        this.$scaleSlider.on('change input', _.bind(function (e) {
    ...
    ImageExplorer.prototype.resetScaleSlider = function (initialValue) {
        ...
        fdSlider._deprecatedUpdateSlider(id); //fdSlider adds an id if the element didn't already have one.
    };
    ...
    ImageExplorer.prototype.showError = function (title, contents) {
        ...
        var $errorMessage = $(aui.message.error({
            titleContent: AJS.escapeHtml(title),
            content: contents || '',
            isCloseable: true
        }));
